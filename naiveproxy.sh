...
echo -e "Naiveproxy status: $yellow Not started, select 4 to restart, and select 8 to view logs and feedback. It is recommended to uninstall and reinstall Naiveproxy-yg$plain"
else
